...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Attributes :  IEquatable<Attributes>, IValidatableObject
    {
        ...
        public Attributes(string id = default(string), string name = default(string), string valueId = default(string), string valueName = default(string), Object valueStruct = default(Object), List<AttributesValues> values = default(List<AttributesValues>), string attributeGroupId = default(string), string attributeGroupName = default(string))
        {
            this.Id = id;
            this.Name = name;
